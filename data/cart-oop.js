...
function Cart (loadFromStorageKey){
    const cart = {
        cartItem:undefined,
        //loading from the cart storage if any method;
        loadFromStorage(){
          this.cartItem = JSON.parse(localStorage.getItem(loadFromStorageKey));
          if(!this.cartItem){
            this.cartItem = [{
        ...
        //saving to storage method
         saveToStorage(){
            localStorage.setItem(loadFromStorageKey,JSON.stringify(this.cartItem));  
        },
